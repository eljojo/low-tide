...
`,Po=f("div")`
  ...
  gap: 0.75rem;
  align-items: center;
`,sn=({job:e})=>{let t=e.title||e.url||e.original_url||`#${e.id}`,n=()=>{J[e.id]="",window.dispatchEvent(new CustomEvent("job-logs-loaded",{detail:{jobId:e.id}})),fetch(`/api/jobs/${e.id}/retry`,{method:"POST"}),S.getState().setConsoleCollapsed(!1)},o=()=>fetch(`/api/jobs/${e.id}/cancel`,{method:"POST"}),r=()=>fetch(`/api/jobs/${e.id}/archive`,{method:"POST"}),a=()=>{confirm("\u26A0\uFE0F Cleanup files? this will delete the files on disk")&&fetch(`/api/jobs/${e.id}/cleanup`,{method:"POST"})},l=()=>{fetch(`/api/jobs/${e.id}/cleanup`,{method:"POST"})},_=(e.files||[]).length>0,d=e.image_path?`/thumbnails/${e.id}`:null;return s(ko,{children:[s(Co,{children:[s(Jo,{className:"lt-job-image-container",children:d?s(No,{className:"lt-job-image",src:d,alt:t,onError:c=>{c.currentTarget.style.display="none"}}):s(To,{className:"lt-job-image-placeholder",children:"No Image"})}),s(Eo,{className:"pane-title-group",children:[s(Ho,{children:s(Lo,{children:t})}),s("div",{className:"lt-actions-row",children:[e.status==="running"&&s(Io,{className:"lt-running-indicator lt-action-indicator",children:[s("span",{className:"lt-indicator-dot"}),"Downloading"]}),e.original_url&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-action-btn",onClick:()=>window.open(e.original_url,"_blank"),children:"Source"}),!e.archived&&(e.status=="success"||e.status=="failed"||e.status==="cancelled")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-action-btn",onClick:r,children:"Archive"}),_&&(e.status=="success"||e.status=="failed"||e.status==="cancelled")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-danger lt-btn-sm lt-action-btn",onClick:a,children:"Cleanup"}),e.status==="running"&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-danger lt-btn-sm lt-action-btn",onClick:o,children:"Cancel"}),(e.status==="failed"||e.status==="cancelled"||e.status==="cleaned")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-action-btn",onClick:n,children:e.status==="cleaned"?"Download again":"Retry"})]}),s("div",{className:"lt-meta",style:{marginTop:"0.4rem"},children:s("span",{children:["Entry #",e.id," \u2022 ",new Date(e.created_at).toLocaleString()]})})]})]}),s(Po,{className:"lt-row",children:[e.original_url&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-bottom-btn",onClick:()=>window.open(e.original_url,"_blank"),children:"Source"}),!e.archived&&(e.status=="success"||e.status=="failed"||e.status==="cancelled")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-bottom-btn",onClick:r,children:"Archive"}),_&&(e.status=="success"||e.status=="failed"||e.status==="cancelled")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-danger lt-btn-sm lt-bottom-btn",onClick:a,children:"Cleanup"}),e.status==="running"&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-danger lt-btn-sm lt-bottom-btn",onClick:o,children:"Cancel"}),(e.status==="failed"||e.status==="cancelled"||e.status==="cleaned")&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm lt-bottom-btn",onClick:n,children:e.status==="cleaned"?"Download again":"Retry"})]})]})};var Ao=f("section")`
  grid-column: 1 / -1;
`,Fo=f("section")`
  margin-top: 2rem;
`,Ro=f("div")`
...
`,cn=()=>{let{jobs:e,selectedJobId:t,consoleCollapsed:n,toggleConsole:o}=S(),r=t?e[t]:null;return r?s(Ao,{className:"lt-card",children:[s(sn,{job:r}),s(ln,{job:r}),r.status!=="queued"&&s(Fo,{children:[s(Ro,{className:"lt-flex-between",children:[s("h3",{className:"lt-title-section",style:{border:"none"},children:"LOGS"}),r.status!=="failed"&&s("button",{className:"lt-btn lt-btn-secondary lt-btn-sm",onClick:o,children:n?"SHOW LOGS":"CLOSE LOGS"})]}),s(Mo,{collapsed:n,className:"lt-log-view",children:s(en,{jobId:r.id})})]})]}):null};var Do=[{id:"archivist",name:"The Archivist"},{id:"midnight-vinyl",name:"Midnight Vinyl"},{id:"the-broadcaster",name:"The Broadcaster"}],un=()=>{let[e,t]=M("archivist");return N(()=>{let o=localStorage.getItem("theme")||"archivist";t(o),document.body.setAttribute("data-theme",o)},[]),s(Oo,{children:[s("label",{className:"lt-label",style:{margin:0,fontSize:"0.65rem"},htmlFor:"theme-switcher",children:"Surface"}),s($o,{id:"theme-switcher",onChange:o=>{let r=o.currentTarget.value;t(r),document.body.setAttribute("data-theme",r),localStorage.setItem("theme",r)},value:e,className:"lt-select",children:Do.map(o=>s("option",{value:o.id,children:o.name},o.id))})]})},Oo=f("div")`
  display: flex;
  align-items: center;
  gap: 0.75rem;
`,$o=f("select")`
...
`;var $e=[{latin:"Utere legitime.",english:"Use lawfully."},{latin:"Ad usum legitimum tantum.",english:"For lawful use only."},{latin:"Responsabilitas penes usorem.",english:"Responsibility lies with the user."},{latin:"Ars technica, non culpa.",english:"A technical tool, not a crime."},{latin:"Fac quod licet.",english:"Do what is permitted."},{latin:"Liberare data, liberare mentes.",english:"Free the data, free the minds."},{latin:"Nullus dominus, nullum archivum clausum.",english:"No masters, no locked archives."},{latin:"Mare liberum, data libera.",english:"The sea is free, the data is free."},{latin:"Omnia communia.",english:"Everything is shared."},{latin:"Si potes legere, potes capere.",english:"If you can read it, you can take it."},{latin:"Ubi copia, ibi gaudium.",english:"Where there are copies, there is joy."},{latin:"Copia non furta est.",english:"Copying is not theft."}],_n=()=>{let[e,t]=M($e[0]);return N(()=>{let n=$e[Math.floor(Math.random()*$e.length)];t(n)},[]),s("footer",{children:[s(Uo,{title:e.english,children:["\u201C",e.latin,"\u201D"]}),s(un,{})]})},Uo=f("span")`
  ...
  opacity: 0.8;
`;bt(C);var Wo=()=>(N(()=>{Wt(),Me()},[]),s(k,{children:[s(jt,{}),s("main",{children:[s(Vt,{}),s(Xt,{}),s(cn,{})]}),s(_n,{})]})),dn=document.getElementById("app");dn&&F(s(Wo,{}),dn);})();
